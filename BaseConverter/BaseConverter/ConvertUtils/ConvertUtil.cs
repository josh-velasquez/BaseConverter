    ...
    internal class ConvertUtil
    {
        ...
        private string[] PrintUnaryToBinaryInstructions()
        {
            return new string[] { "Unary is based on base 1 numerical system. Binary is based on base 2 numerical system.",
                ...
                "Enter your value for every remainder you calculated below and then the final resulting value and see if you got it correct!",
                "",
        ...
        private string[] PrintUnaryToHexadecimalInstructions()
        {
            return new string[] { "Unary is based on base 1 numerical system. Hexadecimal is based on base 16 numerical system",
                ...
                "Enter the remainder for each division below (converted to hexadecimal) and then the final answer and see if you got it correct!",
                "",
        ...
        private string[] PrintBinaryToUnaryInstructions()
        {
            return new string[] { "Binary is based on base 2 numerical system. Unary is based on base 1 numerical system",
                ...
                "Step 3: Once you have the values for each bits calculated, add all of the values up which will yield in the decimal base equivalence \n of the binary value",
                ...
                "Enter the decimal value you calculated for each bit and then enter the final unary value and see if you got it correct!",
                "",
        ...
        private string[] PrintBinaryToDecimalInstructions()
        {
            return new string[] { "Binary is based on the base 2 number system.",
                ...
                "Step 3: Once you have the values for each bits calculated, add all of the values up which will yield in the decimal base equivalence of \n the binary value",
                "\tex. 1 + 0 + 4 + 0 = 5",
        ...
        private string[] PrintDecimalToBinaryInstructions()
        {
            return new string[] { "Binary is based on the base 2 number system",
                ...
                "Step 3: Once the quotient is 0, write the remainders from bottom to top (from your recent remainder calculation to the oldest \n remainder calculation)",
                "\tex. 0b1101 or 1101",
                ...
                "14 // 2 = 7 with a remainder of 0     (Answer = 0 or 0b0)",
                "7 // 2 = 3 with a remainder of 1      (Answer = 1 or 0b1)",
                "3 // 2 = 1 with a remainder of 1      (Answer = 1 or 0b1)",
                "1 // 2 = 0 with a remainder of 1      (Answer = 1 or 0b1)",
        ...
        private string[] PrintDecimalToHexadecimalInstructions()
        {
            return new string[] { "Hexadecimal is based on the base 16 number system",
                ...
                "Step 3: Once you have the values calculated, simply write the remainder values (in hexadecimal) from bottom to top (from your recent \n remainder calculation to the oldest remainder calculation)",
                "\tex. 12 or 0x12",
                ...
                "26 // 16 = 1 with a remainder of 10       (Answer = A or 0xA)",
                "1 // 16 = 0 with a remainder of 1         (Answer = 1 or 0x1)",
        ...
        private string[] PrintHexadecimalToBinaryInstructions()
        {
            return new string[] { "Hexadecimal is based on the base 16 number system. Binary is based on the base 2 number system. Remem",
                "For every four bits, represents one hexedecimal bit. To easily convert a hexadecimal value to binary, it is easier to convert it first to decimal \n and then to binary",
                ...
                "Step 4: Once the quotient is 0, write the remainders from bottom to top (from your recent remainder calculation to the oldest). \nThis is the binary equivalence of that decimal value",
                "\tex. 0b1010 or 1010",
                ...
                "Step 6: Once you have every hexadecimal value calculated, combine all the binary values altogether from bottom to top \n(from your recent binary calculation to the oldest)",
        ...
        {
            return new string[] { "Hexadecimal is based on the base 16 number system.",
                "Step 1: Starting with the very last value or otherwise known as the least significant digit, convert it to its single decimal equivalence \n(see conversion table if you need help)",
                ...
                "Step 4: Once you have the values for each bits calculated, add all of the values up which will yield in the decimal base equivalence of the \nhexadecimal value",
